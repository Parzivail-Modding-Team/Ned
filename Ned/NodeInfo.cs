...
namespace Ned
{
    public class NodeInfo
    {
        ...
        public static readonly NodeInfo Start = new NodeInfo(0, "Interact", false, false,
            node => { node.Outputs.Add(new Connection(node, NodeSide.Output, node.Outputs.Count, "", false)); });

        public static readonly NodeInfo End = new NodeInfo(1, "Exit", false, false,
            node => { node.Input = new Connection(node, NodeSide.Input, 0, ""); });
